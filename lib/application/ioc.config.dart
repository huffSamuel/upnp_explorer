...
import '../presentation/core/bloc/application_bloc.dart' as _i16;
import '../presentation/device/bloc/discovery_bloc.dart' as _i17;
...
Future<_i1.GetIt> $initIoc(
  ...
  gh.singleton<_i16.ApplicationBloc>(
      _i16.ApplicationBloc(get<_i13.ReviewService>()));
  gh.singleton<_i17.DiscoveryBloc>(_i17.DiscoveryBloc(get<_i14.SSDPService>()));
  return get;
}
