...
class _HttpClientResponse extends _HttpInboundMessageListInt
  ...
  final PatchedHttpClient _httpClient;
  ...
  static HttpClientResponseCompressionState _getCompressionState(
      PatchedHttpClient httpClient, _HttpHeaders headers) {
...
class _ConnectionTarget {
  ...
  Future<_ConnectionInfo> connect(Uri uri, String uriHost, int uriPort,
      _Proxy proxy, PatchedHttpClient client, _HttpProfileData? profileData) {
    if (hasIdle) {
...
class PatchedHttpClient implements HttpClient {
  bool _closing = false;
  ...
  PatchedHttpClient(this._context);
