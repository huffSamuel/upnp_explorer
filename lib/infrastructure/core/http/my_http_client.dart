...
class MyHttpClient extends BaseClient {
  ...
  MyHttpClient([HttpClient? inner]) : _inner = inner ?? PatchedHttpClient(null);

  /// Sends an HTTP request and asynchronously returns the response.
  @override
  Future<MyStreamedResponse> send(BaseRequest request) async {
    if (_inner == null) {
